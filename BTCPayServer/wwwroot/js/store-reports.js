...
document.addEventListener("DOMContentLoaded", () => {
    ...
    srv.request.timePeriod.to = toUnix(to);
...
function updateUIDateRange() {
    document.getElementById("toDate")._flatpickr.setDate(fromUnix(srv.request.timePeriod.to));
    document.getElementById("fromDate")._flatpickr.setDate(fromUnix(srv.request.timePeriod.from));
}
...
function downloadCSV() {
    ...
    modifyFields(srv.result.fields, data, 'datetime', v => v ? formatCSVDateTime(v) : v);
